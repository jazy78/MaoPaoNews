package com.example.hp.maopaonews.pullrefreshview;
...
import com.example.hp.maopaonews.pullrefreshview.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /**上拉的状态*/
    private State mPullUpState = ILoadingLayout.State.NONE;
    /**可以下拉刷新的View*/
    T mRefreshableView;
    /**平滑滚动的Runnable*/
