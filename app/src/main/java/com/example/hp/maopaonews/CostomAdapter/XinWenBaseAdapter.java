...
public class XinWenBaseAdapter  extends BaseAdapter{
    ...
    @Override
    public int getCount() {
        return toutiao_list==null?0:toutiao_list.size();
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        switch (type) {
            ...
            case XinWen_adapter.TYPE_zhibo:
                ...
                zhibo.toutiaozb_digest.setText(toutiao_list.get(position).getDigest() + "");
            ...
            case XinWen_adapter.TYPE_duotu:
                ...
                duotu.toutiaodt_replaycount.setText(toutiao_list.get(position).getReplyCount() + "");
